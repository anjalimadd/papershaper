        ...
        <div className="font-sans text-gray-800">
            ...
            <section className="text-center py-16 bg-gray-50">
                ...
                <p className="text-xl md:text-2xl text-gray-600 mt-8 mb-12 max-w-2xl mx-auto">
                    Meet the passionate team behind Paper Shaper's innovative learning solutions
                </p>
            </section>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 justify-items-center">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-xs">
                            ...
                            <p className="text-sm text-gray-600 text-center">
                                Orchestrated project lifecycle management, designed core system architecture,
                                and led backend research initiatives for scalable educational solutions.
                            </p>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 w-full max-w-xs">
                            ...
                            <p className="text-sm text-gray-600 text-center">
                                Enhanced API security layers, optimized database operations,
                                and implemented automated testing frameworks for backend services.
                            </p>
                            <div className="mt-4 flex justify-center">
                                <a
